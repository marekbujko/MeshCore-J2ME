...
public class QrReader
{
	...
	/** Try inverted polarity first, then normal. */
	private boolean tryInverted = true;
	/** {@link QrDetector} */
	...
	public String scan() throws QrReaderException
	{
		...
		if (tLen - 1 < ++tIndex) {
			...
			throw new QrReaderException("Could not find any QR-Code");
		}
		return null;
	}
